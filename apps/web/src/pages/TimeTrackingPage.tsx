...
export default function TimeTrackingPage() {
  ...
  // Check which entry types are supported by user's projects
  const hasIndividualEntryProjects = projects.some((p: any) => p.billing_model !== 'timesheet');
  const hasTimesheetProjects = projects.some((p: any) => p.billing_model === 'timesheet');
